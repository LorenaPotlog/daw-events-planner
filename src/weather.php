...
function accuweather_weather($oras, $id) {
    ...
    $header = getPageContents('https://www.accuweather.com/en/ro/arad/286942/weather-forecast/286942');
    echo 'https://www.accuweather.com/en/ro/'.$oras.'/'.$id.'/daily-weather-forecast/'.$id;
    $html = $header['content'];
    libxml_use_internal_errors(true);
//    echo htmlspecialchars($html);
